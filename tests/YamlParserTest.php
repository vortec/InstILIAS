...
client : 
    ...
    default_password_encoder : md5";
		$obj = $this->parser->read_config($json_string, "\InstILIAS\Config\ClientConfig");

		$this->assertInstanceOf("\InstILIAS\Config\ClientConfig", $obj);
...
db: 
    ...
    type: innodb
    encoding: UTF8';
		$db_config = $this->parser->read_config($json_string, "\InstILIAS\Config\DbConfig");
		$obj = $this->parser->read_config($json_string, "\InstILIAS\Config\DbConfig");

		$this->assertInstanceOf("\InstILIAS\Config\DbConfig", $obj);
...
ilias_git:
    ...
    ilias_git_branch_name: ilias';
		...
		$obj = $this->parser->read_config($json_string, "\InstILIAS\Config\IliasGitConfig");

		$this->assertInstanceOf("\InstILIAS\Config\IliasGitConfig", $obj);
...
lang:
    ...
    to_install_langs:
        - en 
        - de';
		$obj = $this->parser->read_config($json_string, "\InstILIAS\Config\LanguageConfig");

		$this->assertInstanceOf("\InstILIAS\Config\LanguageConfig", $obj);
...
server:
    ...
    timezone: Europe/Berlin';
		$obj = $this->parser->read_config($json_string, "\InstILIAS\Config\ServerConfig");

		$this->assertInstanceOf("\InstILIAS\Config\ServerConfig", $obj);
...
setup:
    passwd: KarlHeinz';
		$obj = $this->parser->read_config($json_string, "\InstILIAS\Config\SetupConfig");

		$this->assertInstanceOf("\InstILIAS\Config\SetupConfig", $obj);
...
tools:
    ...
    unzip: /usr/bin/unzip
    java: /usr/bin/java';
		$obj = $this->parser->read_config($json_string, "\InstILIAS\Config\ToolsConfig");

		$this->assertInstanceOf("\InstILIAS\Config\ToolsConfig", $obj);
...
lang:
    ...
    to_install_langs:
		...
		return array(array($json_string, "\InstILIAS\Config\ClientConfig")
					, array($json_string, "\InstILIAS\Config\DbConfig")
					, array($json_string, "\InstILIAS\Config\IliasGitConfig")
					, array($json_string, "\InstILIAS\Config\LanguageConfig")
					, array($json_string, "\InstILIAS\Config\ServerConfig")
					, array($json_string, "\InstILIAS\Config\SetupConfig")
					, array($json_string, "\InstILIAS\Config\ToolsConfig")
				);
	}
